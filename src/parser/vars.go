...
var (
	...
	shSComment     = singleComment("#")
	aspSComment    = singleComment("'")
	clangSComment  = singleComment("//")
	sqlSComment    = singleComment("--")
	erlangSComment = singleComment("%")
...
var (
	languageData = map[string]models.AvailableLang{
		...
		"erl":      language("Erlang", erlangSComment, noneComment),
		...
		"tex":      language("TeX", erlangSComment, noneComment),
	}
)
